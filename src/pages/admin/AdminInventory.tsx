...
export default function AdminInventory() {
    const { medications, deleteMedication, addMedication } = useDataStore();
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <Button className="bg-[#7B5EA7] text-white gap-2" onClick={() => setShowModal(true)}>
                                    ...
                                    <tr key={med.id} className="hover:bg-[#F3EFF9]/40 transition-colors">
                                        ...
                                        <td className="p-4">
                                            <div className="flex gap-2">
                                                <button className="p-1.5 text-[#3A7DBF] hover:bg-[#EEF4FB] rounded-lg transition-colors">
                                                    <Edit size={16} />
                                                </button>
                                                <button
            ...
            <Modal isOpen={showModal} onClose={() => setShowModal(false)} title="إضافة دواء جديد">
                <div className="space-y-4">
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <Button className="flex-1" loading={submitting} onClick={handleSubmit}>إضافة الدواء</Button>
                    </div>
                </div>
            </Modal>
        </div>
